  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const resMember = await fetch('/api/member?limit=100&sortBy=createdAt&order=desc', { headers });
        ...
        const resIntern = await fetch('/api/intern?limit=100&sortBy=createdAt&order=desc&gen=6', { headers });
