      ...
      <div className="flex items-center gap-3 w-full md:w-auto overflow-x-auto pb-2 md:pb-0 scrollbar-hide">
        ...
        <div className="relative" ref={notiRef}>
          <button
            ...
            className={`p-2.5 rounded-xl transition-all shrink-0 relative group ${isNotiOpen ? "bg-purple-50 text-purple-600 ring-2 ring-purple-100" : "text-slate-500 hover:bg-slate-100 hover:text-slate-700"
              }`}
          >
