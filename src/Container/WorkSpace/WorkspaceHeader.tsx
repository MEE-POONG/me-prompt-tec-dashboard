        ...
        <div>
          <div className="flex items-center gap-3">
            ...
            {workspaceInfo.visibility === "PUBLIC" ? (
              <span
                className="flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-green-50 text-green-600 text-xs font-bold border border-green-100"
                title="Public Board"
              >
              ...
              <span
                className="flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-slate-100 text-slate-500 text-xs font-bold border border-slate-200"
                title="Private Board"
              >
