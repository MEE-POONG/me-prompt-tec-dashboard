    ...
    const [columns, setColumns] = useState<Column[]>([
        {
            ...
            color: 'bg-gray-500',
            tasks: [
                { id: 't1', title: 'Research competitors', tag: 'Research', members: 3, date: 'Nov 24' },
                { id: 't2', title: 'Draft project proposal', tag: 'Planning', members: 2, date: 'Nov 25' },
            ]
        },
        {
            id: 'inprogress',
            ...
            color: 'bg-blue-500',
            tasks: [
                { id: 't3', title: 'Design homepage', tag: 'Design', members: 4, date: 'Nov 28' },
            ]
        },
        {
            id: 'review',
            ...
            color: 'bg-yellow-500',
            tasks: [
                { id: 't4', title: 'Code review for auth', tag: 'Development', members: 2, date: 'Nov 23' },
            ]
        },
        {
            id: 'done',
            ...
            color: 'bg-green-500',
            tasks: [
                { id: 't5', title: 'Setup project repo', tag: 'DevOps', members: 1, date: 'Nov 20' },
            ]
        }
    ]);
    ...
    const onDrop = (e: React.DragEvent, destColId: string) => {
        ...
        const newColumns = columns.map(col => {
            ...
            if (col.id === destColId) {
                ...
                const taskToMove = sourceCol?.tasks.find(t => t.id === draggedTask.taskId);
                if (taskToMove) {
        ...
        <div className="flex h-full overflow-x-auto gap-6 pb-4">
            {columns.map((col) => (
                ...
                >
                    ...
                    {/* Tasks List */}
                    <div className={`p-3 flex-1 overflow-y-auto space-y-3 ${draggedTask && draggedTask.sourceColId !== col.id ? 'bg-gray-100/50' : ''}`}>
                        {col.tasks.map((task) => (
                            <div
                                key={task.id}
                                draggable
