                  ...
                  <div className="flex items-center justify-between pt-2 border-t border-slate-50">
                      ...
                      <div className="flex -space-x-1.5 items-center pl-2">
                          {task.members?.slice(0, 3).map((m, i) => (
                              <div 
                                  key={i} 
                                  className="w-6 h-6 rounded-full ring-2 ring-white bg-linear-to-br from-slate-100 to-slate-200 flex items-center justify-center text-[9px] font-bold text-slate-600 uppercase shadow-sm"
                                  title={m}
                              >
                                  {m.substring(0, 2)}
                              </div>
