        ...
        >
          <div
            className={`
                    ...
                    ${
                      isAccepted
                        ? "hover:shadow-lg hover:bg-emerald-100/60"
          ...
          >
            ...
            <div className="flex items-start justify-between mb-2.5">
              <div className="flex flex-wrap gap-1.5">
                <span
                  className={`px-2 py-0.5 rounded-md text-[10px] uppercase font-bold tracking-wide border ${
                    task.tagColor ||
                ...
                {task.priority && (
                  <span
                    className={`px-2 py-0.5 rounded-md text-[10px] uppercase font-bold tracking-wide border flex items-center gap-1 ${getPriorityStyle(
                      task.priority
                    )}`}
                  >
                ...
                {onQuickJoin && (
                  <button
                    ...
                    className={`
                                ...
                                `}
                    title={
                      isAccepted ? "กดเพื่อยกเลิกรับงาน" : "กดเพื่อรับงานนี้"
                    }
                  >
                    <CheckCircle2
                      size={16}
                      className={
                        isAccepted ? "fill-white text-emerald-500" : ""
                      }
                    />
                  </button>
                )}
