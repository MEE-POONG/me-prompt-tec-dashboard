...
const INITIAL_EVENTS: TimelineEvent[] = [
  { id: 1, title: "Design Wireframes", startDate: new Date(2025, 11, 2), endDate: new Date(2025, 11, 6), color: "bg-blue-500", status: "In Progress" },
  { id: 2, title: "Market Analysis", startDate: new Date(2025, 11, 8), endDate: new Date(2025, 11, 11), color: "bg-purple-500", status: "Research" },
  { id: 3, title: "API Integration", startDate: new Date(2025, 11, 15), endDate: new Date(2025, 11, 22), color: "bg-green-500", status: "Dev" },
];

const TAGS = [
  { id: 1, color: "bg-red-500", label: "Urgent" },
  { id: 2, color: "bg-purple-500", label: "Design" },
  { id: 3, color: "bg-blue-500", label: "Dev" },
  { id: 4, color: "bg-green-500", label: "QA" },
];

const MEMBERS = [
  { id: 1, name: "Alex L.", avatar: "bg-blue-100 text-blue-600" },
  { id: 2, name: "Sarah J.", avatar: "bg-pink-100 text-pink-600" },
  { id: 3, name: "Mike K.", avatar: "bg-green-100 text-green-600" },
];
            ...
            <div className="relative" ref={filterButtonRef}>
                ...
                {isFilterPopoverOpen && (
                    <div className="absolute top-full right-0 mt-2 w-72 bg-white rounded-xl shadow-xl border border-gray-200 p-4 z-50 animate-in fade-in zoom-in-95">
                        ...
                        <div className="mb-4">
                            <p className="text-xs font-bold text-gray-400 uppercase mb-2">Members</p>
                            <div className="space-y-2">
                                {MEMBERS.map(m => (
                                    <label key={m.id} className="flex items-center gap-3 cursor-pointer group">
                                        ...
                                        <div className={`w-6 h-6 rounded-full flex items-center justify-center text-[10px] font-bold ${m.avatar}`}>
                                            {m.name.charAt(0)}
                                        </div>
                                        <span className="text-sm text-gray-600 group-hover:text-gray-900">{m.name}</span>
                                    </label>
                                ))}
                            </div>
                        </div>
                            ...
                            <div className="space-y-2">
                                {TAGS.map(t => (
                                    <label key={t.id} className="flex items-center gap-3 cursor-pointer group">
                                        <input type="checkbox" className="rounded border-gray-300 text-blue-600 focus:ring-0" />
                                        <div className={`w-16 h-2 rounded-full ${t.color}`}></div>
