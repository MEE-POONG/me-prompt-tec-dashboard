...
import ProjectReport from "./Views/ProjectReport"; // ✅ Import เพิ่มตรงนี้
...
export default function WorkspaceBoard({ workspaceId }: WorkspaceBoardProps) {
  ...
  // State สำหรับ Filter และ View (เพิ่ม 'report' เข้าไปใน Type)
          ...
          <div className="px-6 flex items-center justify-between">
            ...
            <div className="flex items-center gap-6">
                ...
                >
                 ...
                 <button 
                    onClick={() => setCurrentView("report")} // ✅ เพิ่ม onClick
                            ...
                            >
                                <Droppable droppableId={String(col.id)}>
                                    ...
                                    <div
                                        ...
                                        className={`px-3 pb-3 flex-1 overflow-y-auto min-h-[150px] transition-colors rounded-b-2xl scrollbar-hide ${
