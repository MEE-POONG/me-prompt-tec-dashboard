            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-slate-500 mt-1 font-medium">
                        ผู้ดูแลระบบและสมาชิกทั้งหมด <span className="bg-blue-50 text-blue-600 px-2 py-0.5 rounded-md font-bold ml-1">{accounts.length} บัญชี</span>
                    </p>
                </div>
            </div>
          ...
          <div className="bg-white/80 backdrop-blur-xl rounded-4xl shadow-sm overflow-hidden border border-white/60">
            <div className="overflow-x-auto">
                ...
                <tbody className="divide-y divide-slate-50 text-sm">
                    {loading ? (
                        <tr><td colSpan={6} className="p-10 text-center text-slate-400">กำลังโหลดข้อมูล...</td></tr>
                    ...
                    filteredAccounts.map((acc) => (
                        ...
                        <td className="p-5 text-center">
                            <span className={`px-3 py-1 rounded-full text-xs font-bold border ${
                                acc.role === 'admin' ? 'bg-purple-50 text-purple-600 border-purple-100' :
                                acc.role === 'staff' ? 'bg-blue-50 text-blue-600 border-blue-100' :
                    ...
                    <tr>
                        ...
                        {searchTerm ? "ไม่พบข้อมูลที่ค้นหา" : "ยังไม่มีข้อมูลบัญชีผู้ใช้"}
                        </td>
                    </tr>
                    )}
                </tbody>
