...
import { FileText, LinkIcon, Plus, Type, Upload, X, Loader2 } from "lucide-react";
  ...
  const fetchProject = async (projectId: string) => {
    try {
      ...
      if (response.ok) {
        ...
        setClientSector(project.clientSector || "");
          ...
          >
            ...
            <div className="p-6 md:p-8 border-t border-gray-100 bg-gray-50 flex justify-end gap-4">
              ...
              >
                ...
                {loading ? "กำลังอัปเดต..." : "อัปเดตโปรเจกต์"}
              </button>
            </div>
          </form>
        </div>
