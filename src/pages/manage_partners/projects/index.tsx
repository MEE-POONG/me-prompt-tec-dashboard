...
import Layouts from "@/components/Layouts"; // Layout หลักของคุณ
import Image from "next/image";
import Link from "next/link";
import { 
  Search, LayoutGrid, List, Trash2, FolderGit2, 
  Plus, Edit3, Eye, Building2, Calendar 
} from "lucide-react";
...
const mockProjects: ProjectData[] = [
  {
    ...
    imageUrl: "/image/AI.png", // เปลี่ยนเป็น path รูปจริงของคุณ
    status: "Published",
